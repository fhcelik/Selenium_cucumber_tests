...
public class SubWebSiteLinksCheck {
	WebDriver driver;
	
	private static final String WEBSITE_URL = HomePage.HOME_URL+"/digital-cameras";
	private static final By ALL_LINKS = By.tagName("a");
	String url = "";
    HttpURLConnection huc = null;
    int respCode = 200;
    
	@Given("^Open digital cameras site$")
	public static void open_site() {
	    // Write code here that turns the phrase above into concrete actions
			get(WEBSITE_URL);
			getDriver().manage().window().maximize();
	} 
	@When("^Check digital cameras all links$")
	...
	@Then("^Digital cameras all links should be successful$")
